...
namespace Variant {
	...
	void Renderer2D::Init()
	{
		...
		s_rendererData->batch_buffer = new Vertex[s_rendererData->maxVertices];
		...
		//s_rendererData->batch_index = new unsigned int[s_rendererData->maxIndices];
		s_rendererData->indexBuffer.reset(indexBuffer::Create((void*)indices,sizeof(indices)));
		...
		s_rendererData->whiteTexture.reset(new Texture(glm::vec4(1.0, 0.5, 0.0, 1.0)));
